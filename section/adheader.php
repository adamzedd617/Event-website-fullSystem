...
<nav class="nav justify-content-center border-bottom">
  <a class="nav-link " href="index.php"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>
  <a class="nav-link " href="../index.html">My Events</a>
  <!-- <a class="nav-link " href="search.php">Search</a> 
  <a class="nav-link " href="addP.php">Add_Participate</a> 
  <a class="nav-link " href="addC.php">Add_Crew</a> 
  <a class="nav-link " href="listc.php">List_Crew</a> -->
  ...
  <header class="page-header">
    <nav>
      ...
      <ul class="admin-menu">
        ...
        <li>
          <a href="update.php?id=1&user=crew">
            <svg>
